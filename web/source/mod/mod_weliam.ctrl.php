<?php
/**
 * [开吧授权系统 System] Copyright (c) 2018 33f3.CN
 * 开吧授权系统 is NOT a free software, it under the license terms, visited https://www.kai8.top/ for more details.
 */
...
if ($do == 'upgrade') {
    ...
    if (empty($_W['setting']['cloudip']) || $_W['setting']['cloudip']['expire'] < TIMESTAMP) {
        $cloudip = gethostbyname('sq.kai8.top');
