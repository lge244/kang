...
<div class="container-fluid footer text-center" role="footer">
	...
	<div class="copyright"><?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.kai8.top/"><b>开吧源码社区</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2015 <a href="http://www.kai8.top">www.kai8.top</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?></div>
