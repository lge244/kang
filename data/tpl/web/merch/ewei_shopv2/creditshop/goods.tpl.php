...
<div class="page-content">
        ...
        <div class="page-toolbar">
            <div class="col-sm-5">
                 <span class='pull-left'>
                    <?php if(mcv('creditshop.goods.add')) { ?>
    ...
    <form action="" method="post">
        ...
        <div class="page-table-header" style="border: none;">
            <input type="checkbox">
            <div class="btn-group">
                <?php if(mcv('creditshop.goods.edit')) { ?>
                ...
                <?php  } ?>
                <?php if(mcv('creditshop.goods.delete' && $_GPC['tab']!='recycle' && $_GPC['tab']!='warehouse')) { ?>
                ...
                <?php  } ?>
                <?php if(mcv('creditshop.goods.delete' && $_GPC['tab']!='recycle')) { ?>
        ...
        <table class="table table-hover table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                       <?php if(mcv('creditshop.adv.edit')) { ?>
                    ...
                    <td style="text-align: center;">
                         <?php if(mcv('creditshop.goods.view|creditshop.goods.edit')) { ?>
                             <a class='btn btn-default btn-sm btn-op btn-operation' href="<?php  echo webUrl('creditshop/goods/edit',array('id' => $row['id']));?>" title="">
                                 <span data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php if(mcv('creditshop.goods.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?>">
                                     <?php if(mcv('creditshop.goods.edit')) { ?>
                         ...
                         <?php  } ?>
                         <?php if(mcv('creditshop.goods.delete' && $_GPC['tab']!='warehouse' && $_GPC['tab']!='recycle')) { ?>
                         ...
                         <?php  } ?>
                         <?php if(mcv('creditshop.goods.delete')) { ?>
