...
<div class="page-content">
    ...
    <div class="alert alert-primary">
        <p><b>发布审核说明</b></p>
        <p>*上传代码：上传代码后可获取体验二维码</p>
        <p>*提交审核：提交审核后系统将直接提交至微信审核，<span style="color:red">提交审核需先上传代码，否则小程序版本不是最新</span></p>
    ...
    <div class="wxapp-detail">
        ...
        <div class="btn btn-primary btn-audit" data-action="upload" data-text="上传代码" style="margin-top: 0px;margin-bottom: 10px">上传代码</div>
