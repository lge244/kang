...
<?php if(cv('member.list.edit')) { ?>
<div class="form-group">
    <label class="col-lg control-label">当日消费金额</label>
    <div class="col-sm-9 col-xs-12">
        <?php  echo tpl_form_field_editor(array('name'=>'data[today_price]', 'value'=>$member['today_price']))?>
    </div>
</div>
<div class="form-group">
    <label class="col-lg control-label">总消费金额</label>
    <div class="col-sm-9 col-xs-12">
        <?php  echo tpl_form_field_editor(array('name'=>'data[sum_price]', 'value'=>$member['sum_price']))?>
    </div>
</div>
<?php  } ?>
