...
<div class="pull-left">
    ...
    <?php  } ?>
    <a class='btn btn-primary btn-sm talk' href="JavaScript:;" ><i class='fa fa-plus'></i> 导入会员</a>
...
<script>
    ...
    $('.talk').click(function () {
        layer.open({
            ...
            type: 2,
            area: ['700px', '440px'],
            content: "<?php  echo webUrl('member/join')?>" //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
        });
    })
</script>
