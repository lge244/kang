    ...
    <div class="fui-content navbar">
        ...
        <div class='fui-content-inner'>
            ...
            <div class="fui-goods-group container block" id="goods-list-container">
                <?php  if(is_array($goods)) { foreach($goods as $index => $g) { ?>
                <div class="fui-goods-item" data-goodsid="<?php  echo $g['id'];?>" data-type="<?php  echo $g['type'];?>">

                    <a href="./index.php?i=5&amp;c=entry&amp;m=ewei_shopv2&amp;do=mobile&amp;r=goods.detail&amp;mid=1&amp;id=<?php  echo $g['id'];?>">

                        <div class="image" data-lazyloaded="true" style="background-image: url(<?php  echo $g['thumb'];?>);">
                </div>
                        <div class="detail">

                            <a href="./index.php?i=5&amp;c=entry&amp;m=ewei_shopv2&amp;do=mobile&amp;r=goods.detail&amp;mid=1&amp;id=5">

                                <div class="name"> <?php  echo $g['title'];?></div>

                            </a>

                            <div style="line-height:0.7rem;height:0.7rem;color:#b2b2b2;font-size:0.6rem;margin-top: .2rem;text-decoration: line-through"><?php  echo $g['productprice'];?></div>

                            <div class="price" style="margin-top: 0">

                                <span class="text"><?php  echo $g['marketprice'];?></span>

                                <span class="buy" data-type="1">购买</span>
...
<!--            &lt;!&ndash; <div class="salez" style="background-image: url('<?php  echo tomedia($_W['shopset']['shop']['saleout'])?>'); "></div> &ndash;&gt;-->

<!--            &lt;!&ndash;<a <%if g.bargain>0%>href="<?php  echo mobileUrl('bargain/detail')?>&id=<%g.bargain%>"<%else%>href="<?php  echo mobileUrl('goods/detail')?>&id=<%g.id%>"<%/if%>>&ndash;&gt;-->

<!--            &lt;!&ndash;<?php  if(!empty($_W['shopset']['shop']['saleout'])) { ?>&ndash;&gt;-->

<!--            &lt;!&ndash;<%if g.total<=0%><div class="salez" style="background-image: url('<?php  echo tomedia($_W['shopset']['shop']['saleout'])?>'); "></div><%/if%>&ndash;&gt;-->

<!--            &lt;!&ndash;<?php  } else { ?>&ndash;&gt;-->

<!--            &lt;!&ndash;<%if g.total<=0%><div class="salez" style="background-image: url('<?php  echo '../addons/ewei_shopv2/static/images/shouqin.png'?>'); "></div><%/if%>&ndash;&gt;-->
