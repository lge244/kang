<?php defined('IN_IA') or exit('Access Denied');?><link rel="stylesheet" href="../../../../../../../Downloads/animate.min.css"><?php (!empty($this) && $this instanceof WeModuleSite) ? (include $this->template('_header', TEMPLATE_INCLUDEPATH)) : (include template('_header', TEMPLATE_INCLUDEPATH));?>
    ...
    <div class="fui-content">
        ...
        <div class="acc-input-group">
            ...
            <div class="acc-input">
                ...
                <div class="input">
                    <input type="password" class="input-inner" value="" placeholder="请输入安全密码（用于转账提现等）" name="safety" id="safety" maxlength="20" />
                </div>
            </div>
        </div>

        <div class="btn" id="btnSubmit" style="background-color: orange;"><?php  if(empty($type)) { ?>立即注册<?php  } else { ?>立即找回<?php  } ?></div>
        <div class="text">
