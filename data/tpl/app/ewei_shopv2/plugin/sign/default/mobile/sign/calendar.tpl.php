...
<div class="week">
    ...
    <nav class="day <?php  if(!empty($day['today'])) { ?>today<?php  } ?>" data-day="<?php  echo $day['day'];?>" data-month="<?php  echo $day['month'];?>" data-date="<?php  echo $day['date'];?>" data-signed="<?php  echo $day['signed'];?>" data-year="<?php  echo $day['year'];?>">
